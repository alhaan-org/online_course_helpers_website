        ...
        <div class="row align-items-center g-5">
          ...
          <div class="col-lg-6" data-aos="fade-up">
            <div class="image-placeholder">
              <img src="assets/img/online-ed-course-help.webp" alt="OnlineEd Course Help" class="img-fluid"
                loading="lazy" />
            </div>
          </div>
          <!-- Left Content -->
      ...
      <div class="container">
        <div class="d-flex flex-column flex-md-row align-items-center justify-content-between">
          ...
          <div class="image-right mt-4 mt-md-0">
            <img src="assets/img/help-with-online-ed-course.webp" alt="Help with OnlineEd Course"
          ...
          <div class="col-lg-5">
            <div class="hero-image-frame">
              <div class="cheap-price-section-image-placeholder">
                <img src="assets/img/take-my-online-ed-course.webp" alt="Take My OnlineEd Course" loading="lazy" />
              </div>
            </div>
          </div>
          ...
          <div class="item h-100">
            <div class="support-box p-4 rounded-4 shadow-sm">
              ...
              <p class="small"><span style="font-weight: 400">OnlineEd is a specialized course for
                ...
                </span><span style="font-weight: 400">OnlineEd course helpers</span><span style="font-weight: 400">
                  provide personal guidance across all specialization paths,
