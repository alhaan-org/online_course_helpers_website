            ...
            <div class="course-card-container">
                <div class="course-card">
                    <div class="card-content">
                        ...
                        <p>We help with probability, data analysis, testing hypotheses and so on. Be it learning distributions or assignments, our professionals make complex issues simple. Master real-life data interpretation as you get assistance with projects, quizzes and exams. It is easy and more affordable to score highly in your statistics course with our help.</p>
                        <button class="btn btn-dark">Live Chat</button>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="d-flex flex-column flex-md-row align-items-center justify-content-between">
            ...
            <div class="image-right mt-4 mt-md-0">
                <img src="../assets/pay-someone-to-do-assignment-reviews-2.webp" alt="Support Specialist" class="img-fluid custom-img">
            </div>
        </div>
    </div>
</section>
