      ...
      <div class="navbar-collapse collapse py-3 show" id="navbarNav">
        <ul class="navbar-nav mx-auto gap-2 gap-lg-3 p-2 align-items-start align-items-lg-center">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu shadow border-0" style="min-width: 250px; max-height: 400px; overflow-y: auto;">
        ...
        <div class="d-flex align-items-center">
          <a href="javascript:void(0)" onclick="parent.Tawk_API.toggle();" class="btn btn-primary-custom">
