      ...
      <div class="container">
        <div class="d-flex flex-column flex-md-row align-items-center justify-content-between">
          ...
          <div class="image-right mt-4 mt-md-0">
            <img src="assets/img/help-with-online-straighterline-course.webp"
              alt="Help with Online Straighterline Course" class="img-fluid custom-img" loading="lazy">
          </div>
        </div>
      </div>
    </section>
          ...
          <div class="col-lg-5">
            <div class="hero-image-frame">
              <div class="cheap-price-section-image-placeholder">
                <img src="assets/img/take-my-online-straighterline-course.webp"
                  alt="Take My Online Straighterline Course" loading="lazy" />
              </div>
            </div>
          </div>
          ...
          <div class="item h-100">
            <div class="support-box p-4 rounded-4 shadow-sm">
              ...
              <p class="small"><span style="font-weight: 400">Straighterline's general education and
                  ...
                  style="font-weight: 400">Straighterline course takers</span><span style="font-weight: 400"> to get a
                  complete </span><span style="font-weight: 400">guide for the Straighterline course</span><span
