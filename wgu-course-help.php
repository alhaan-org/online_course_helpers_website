        ...
        <div class="row align-items-center g-5">
          ...
          <div class="col-lg-6" data-aos="fade-up">
            <div class="image-placeholder">
              <img src="assets/img/online-wgu-course-help.webp" alt="Online WGU Course Help" class="img-fluid"
                loading="lazy" />
            </div>
          </div>
          <!-- Left Content -->
      ...
      <div class="container">
        <div class="d-flex flex-column flex-md-row align-items-center justify-content-between">
          ...
          <div class="image-right mt-4 mt-md-0">
            <img src="assets/img/help-with-online-wgu-course.webp" alt="Help with Online WGU Course"
          ...
          <div class="col-lg-5">
            <div class="hero-image-frame">
              <div class="cheap-price-section-image-placeholder">
                <img src="assets/img/take-my-online-wgu-course.webp" alt="Take My Online WGU Course" loading="lazy" />
              </div>
            </div>
          </div>
          ...
          <div class="item h-100">
            <div class="support-box p-4 rounded-4 shadow-sm">
              ...
              <p class="small"><span style="font-weight: 400">WGU offers single courses primarily at the
                ...
                </span><span style="font-weight: 400">help with WGU course</span><span style="font-weight: 400">, we are
                  here to help you. </span></p>
            </div>
          </div>
          <div class="item h-100">
            <div class="support-box p-4 rounded-4 shadow-sm">
              ...
              <p class="small"><span style="font-weight: 400">WGU bachelor’s degree programs are designed
                  ...
                  you don’t have enough time and are looking for someone to </span><span style="font-weight: 400">take
                  my WGU course</span><span style="font-weight: 400">,
